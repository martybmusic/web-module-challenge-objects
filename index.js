...
console.log(createMenuItem('waffles', 9, 'breakfast'))
...
export const burger = {
  ...
  discount: function(discountClass) {
    if (discountClass == 'student' || discountClass == 'teacher') {
...
reviews.push ({
  name: 'Aniket',
  rating: 5,
  feedback: 'This is hands-down my favorite restaurant in the city. Strongly recommend',
})
